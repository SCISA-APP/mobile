...
const ProfessionalCounselorDetailsScreen = () => {
  ...
  const renderContent = () => {
    if (activeTab === 'About') {
      return <ThemedText style={styles.bio}>{counselor.bio}</ThemedText>;
    }
    return (
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.userInfoContainer}>
          ...
          <ThemedText style={styles.department}>@{counselor.department.replace(/\s+/g, '').toLowerCase()}</ThemedText>
        </View>
...
export default ProfessionalCounselorDetailsScreen;
