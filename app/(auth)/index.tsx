...
const WelcomeScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      let storedUser = null;
      let hasOpenedBefore = null;

      // Only use AsyncStorage on native platforms
      if (Platform.OS !== 'web') {
        storedUser = await AsyncStorage.getItem("@student_user");
        hasOpenedBefore = await AsyncStorage.getItem("hasOpenedBefore");
      }
      ...
      if (!hasOpenedBefore && Platform.OS !== 'web') {
